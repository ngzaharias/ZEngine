...
template<>
void Visitor::ReadCustom(shared::tactics::Path& value) const
{
	Read(strNodes, value.m_Nodes, value.m_Nodes);
}

template<>
void Visitor::ReadCustom(shared::tactics::Rush& value) const
{
	Read(strDirection, value.m_Direction, value.m_Direction);
}

template<>
void Visitor::ReadCustom(shared::tactics::Teleport& value) const
{
	Read(strOffset, value.m_Offset, value.m_Offset);
}

template<>
void Visitor::ReadCustom(shared::tactics::Ability& value) const
{
