...
TEST_CASE("math::Vector4f::Constructors")
{
	{
		INFO("Alignment");
	...
	{
		INFO("Vector4f(float, float, float, float)");
...
TEST_CASE("math::Vector4f::Operators")
{
	{
		INFO("operator==(Vector4f)");
...
TEST_CASE("math::Vector4f::Length")
{
...
TEST_CASE("math::Vector4f::LengthSqr")
{
...
TEST_CASE("math::Vector4f::Normalize")
{
...
TEST_CASE("math::Vector4f::Normalized")
{
