...
TEST_CASE("Quaternion. Quaternion(Vector3f).")
{
...
TEST_CASE("Quaternion. Quaternion(Vector4f).")
{
...
TEST_CASE("Quaternion. operator/(float).")
{
...
TEST_CASE("Quaternion. LengthSqr.")
{
...
TEST_CASE("Quaternion. NormalizeUnsafe.")
{
	Quaternion quaternionA = Quaternion::AxisX;
...
TEST_CASE("Quaternion. NormalizedUnsafe.")
{
...
TEST_CASE("Quaternion. operator*(Vector2f, Quaternion).")
{
