...
TEST_CASE("math::IsNearly(Vector2f). Exact match and near origin.")
{
...
TEST_CASE("math::Angle(Vector2f). Perpendicular.")
{
	const Vector2f a = Vector2f(0.f, 1.f);
...
TEST_CASE("math::Angle(Vector2f). Parallel and opposite direction.")
{
	const Vector2f a = Vector2f(0.f, +1.f);
	const Vector2f b = Vector2f(0.f, -1.f);
	const float angle = math::Angle(a, b);
...
TEST_CASE("math::Angle(Vector3f). Parallel and same direction.")
{
...
TEST_CASE("math::Angle(Vector3f). Perpendicular.")
{
	const Vector3f a = Vector3f(0.f, 0.f, 1.f);
...
TEST_CASE("math::Angle(Vector3f). Parallel and opposite direction.")
{
	const Vector3f a = Vector3f(0.f, 0.f, +1.f);
	const Vector3f b = Vector3f(0.f, 0.f, -1.f);
	const float angle = math::Angle(a, b);
...
TEST_CASE("math::ClampLength(Vector2f).")
{
...
TEST_CASE("math::ClampLength(Vector3f).")
{
...
TEST_CASE("math::Distance(Vector2f).")
{
...
TEST_CASE("math::Distance(Vector3f).")
{
...
TEST_CASE("math::DistanceSqr(Vector2f).")
{
...
TEST_CASE("math::DistanceSqr(Vector3f).")
{
...
TEST_CASE("math::Divide(Vector2f).")
{
...
TEST_CASE("math::Divide(Vector3f).")
{
...
TEST_CASE("math::Multiply(Vector2f).")
{
...
TEST_CASE("math::Multiply(Vector3f).")
{
...
TEST_CASE("math::Perpendicular(Vector2f).")
{
...
TEST_CASE("math::Project(Vector3f Line3f). Point is projected to first Line3f point.")
{
...
TEST_CASE("math::Project(Vector3f Line3f). Point is projected midway between the Line3f points.")
{
	constexpr Line3f lineX = Line3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Line3f lineY = Line3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Line3f lineZ = Line3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Line3f). Point is projected to second Line3f point.")
{
	constexpr Line3f lineX = Line3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Line3f lineY = Line3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Line3f lineZ = Line3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Line3f). Point is projected beyond the first Line3f point.")
{
	constexpr Line3f lineX = Line3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Line3f lineY = Line3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Line3f lineZ = Line3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Line3f). Point is projected beyond the second Line3f point.")
{
	constexpr Line3f lineX = Line3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Line3f lineY = Line3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Line3f lineZ = Line3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Ray3f). Point is projected to Ray3f origin.")
{
...
TEST_CASE("math::Project(Vector3f Ray3f). Point is projected along ray.")
{
	constexpr Ray3f rayNegX = Ray3f(+Vector3f::AxisX, -Vector3f::AxisX);
	constexpr Ray3f rayNegY = Ray3f(+Vector3f::AxisY, -Vector3f::AxisY);
	constexpr Ray3f rayNegZ = Ray3f(+Vector3f::AxisZ, -Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Ray3f). Point is projected behind ray.")
{
	constexpr Ray3f rayNegX = Ray3f(+Vector3f::AxisX, -Vector3f::AxisX);
	constexpr Ray3f rayNegY = Ray3f(+Vector3f::AxisY, -Vector3f::AxisY);
	constexpr Ray3f rayNegZ = Ray3f(+Vector3f::AxisZ, -Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Segment3f). Point is projected to first Segment3f point.")
{
...
TEST_CASE("math::Project(Vector3f Segment3f). Point is projected midway between the Segment3f points.")
{
	constexpr Segment3f segmentX = Segment3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Segment3f segmentY = Segment3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Segment3f segmentZ = Segment3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Segment3f). Point is projected to second Segment3f point.")
{
	constexpr Segment3f segmentX = Segment3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Segment3f segmentY = Segment3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Segment3f segmentZ = Segment3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Segment3f). Point is beyond first point but projected to the first Line3f point.")
{
	constexpr Segment3f segmentX = Segment3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Segment3f segmentY = Segment3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Segment3f segmentZ = Segment3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::Project(Vector3f Segment3f). Point is beyond second point but projected to the second Line3f point.")
{
	constexpr Segment3f segmentX = Segment3f(-Vector3f::AxisX, +Vector3f::AxisX);
	constexpr Segment3f segmentY = Segment3f(-Vector3f::AxisY, +Vector3f::AxisY);
	constexpr Segment3f segmentZ = Segment3f(-Vector3f::AxisZ, +Vector3f::AxisZ);
...
TEST_CASE("math::ProjectXY(Vector3f Ray3f).")
{
	// min
...
TEST_CASE("math::ProjectXY(Vector3f Segment3f).")
{
	// min
...
TEST_CASE("math::ProjectXZ(Vector3f Ray3f).")
{
	// min
...
TEST_CASE("math::ProjectXZ(Vector3f Segment3f).")
{
	// min
...
TEST_CASE("math::Reflect(Vector2f).")
{
	CHECK(false);
}

TEST_CASE("math::ToGridPos(Vector2f). Origin.")
{
...
TEST_CASE("math::ToGridPos(Vector2f). Inside centre.")
{
...
TEST_CASE("math::ToGridPos(Vector2f). Inside bottom left.")
{
...
TEST_CASE("math::ToGridPos(Vector2f). Inside top right.")
{
...
TEST_CASE("math::ToGridPos(Vector2f). Outside bottom left.")
{
...
TEST_CASE("math::ToGridPos(Vector2f). Outside top right.")
{
...
TEST_CASE("math::ToGridPos(Vector3f). Origin.")
{
...
TEST_CASE("math::ToGridPos(Vector3f). Inside centre.")
{
...
TEST_CASE("math::ToGridPos(Vector3f). Inside bottom left.")
{
...
TEST_CASE("math::ToGridPos(Vector3f). Inside top right.")
{
...
TEST_CASE("math::ToGridPos(Vector3f). Outside bottom left.")
{
...
TEST_CASE("math::ToGridPos(Vector3f). Outside top right.")
{
...
TEST_CASE("math::ToWorldPos(Vector2i).")
{
	CHECK(false);
}

TEST_CASE("math::ToWorldPos(Vector3i)")
{
	CHECK(false);
}