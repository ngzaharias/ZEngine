...
template<>
void eng::Visitor::ReadCustom(eng::settings::DebugStaticComponent& value) const
{
...
template<>
void eng::Visitor::WriteCustom(const eng::settings::DebugStaticComponent& value)
{
...
template<>
bool imgui::Inspector::WriteCustom(eng::settings::DebugStaticComponent& value)
{
	bool result = false;
