...
void eng::LinesStaticComponent::AddAABB(const AABB3f& extents, const Colour& colour)
{
	AddAABB(Vector3f::Zero, extents, colour);
}

void eng::LinesStaticComponent::AddAABB(const Vector3f& translate, const float extents, const Colour& colour)
{
	Vector3f corners[8];
...
void eng::LinesStaticComponent::AddAABB(const Vector3f& translate, const Vector3f& extents, const Colour& colour)
{
	Vector3f corners[8];
...
void eng::LinesStaticComponent::AddAABB(const Vector3f& translate, const AABB3f& extents, const Colour& colour)
{
	Vector3f corners[8];
...
void eng::LinesStaticComponent::AddCircle(const Vector3f& translate, const Circle2f& circle, const float steps, const Colour& colour)
{
...
void eng::LinesStaticComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::Projection& projection, const Vector2u& size, const Colour& colour)
{
	std::visit([&](auto projection) { AddFrustrum(translate, rotate, projection, size, colour); }, projection);
}

void eng::LinesStaticComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::Orthographic& projection, const Vector2u& size, const Colour& colour)
{
...
void eng::LinesStaticComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::Perspective& projection, const Vector2u& size, const Colour& colour)
{
...
void eng::LinesStaticComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::camera::UserInterface& projection, const Vector2u& size, const Colour& colour)
{
}

void eng::LinesStaticComponent::AddHexagon(const Vector3f& translate, const float radius, const Colour& colour)
{
...
void eng::LinesStaticComponent::AddIcosphere(const Vector3f& translate, const Sphere3f& sphere, const Colour& colour)
{
...
void eng::LinesStaticComponent::AddLine(const Vector3f& pointA, const Vector3f& pointB, const Colour& colour)
{
	m_Vertices.Append({ pointA, colour });
	m_Vertices.Append({ pointB, colour });
}

void eng::LinesStaticComponent::AddOBB(const Vector3f& translate, const OBB3f& obb, const Colour& colour)
{
...
void eng::LinesStaticComponent::AddSphere(const Sphere3f& sphere, const Colour& colour)
{
	AddSphere(Vector3f::Zero, sphere, colour);
}

void eng::LinesStaticComponent::AddSphere(const Vector3f& translate, const float radius, const Colour& colour)
{
	Vector3f corners[8];
...
void eng::LinesStaticComponent::AddSphere(const Vector3f& translate, const Sphere3f& sphere, const Colour& colour)
{
