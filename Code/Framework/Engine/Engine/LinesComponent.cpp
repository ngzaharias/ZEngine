...
void eng::LinesComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::Projection& projection, const Vector2u& size, const Colour& colour)
{
	std::visit([&](auto projection) { AddFrustrum(translate, rotate, projection, size, colour); }, projection);
}

void eng::LinesComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::Orthographic& projection, const Vector2u& size, const Colour& colour)
{
...
void eng::LinesComponent::AddFrustrum(const Vector3f& translate, const Rotator& rotate, const eng::Perspective& projection, const Vector2u& size, const Colour& colour)
{
