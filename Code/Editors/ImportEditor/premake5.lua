project "ImportEditor"
	kind "StaticLib"
	pchheader "ImportPCH.h"
	pchsource "ImportEditor/ImportPCH.cpp"
	location "%{wks.location}/Editors/ImportEditor"
	...
	{ 
		...
		"%{wks.location}/../Code/Editors/ImportEditor/",
