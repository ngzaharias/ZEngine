...
template<>
void eng::Visitor::ReadCustom(editor::inspector::SettingsStaticComponent& value) const
{
	Read(strOpen, value.m_Open, value.m_Open);
	Read(strSave, value.m_Save, value.m_Save);
}
template<>
void eng::Visitor::WriteCustom(const editor::inspector::SettingsStaticComponent& value)
{
