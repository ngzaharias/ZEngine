...
template<>
void eng::Visitor::ReadCustom(editor::flipbook::SettingsStaticComponent& value) const
{
...
template<>
void eng::Visitor::WriteCustom(const editor::flipbook::SettingsStaticComponent& value)
{
