...
template<>
void eng::Visitor::ReadCustom(editor::texture::SettingsStaticComponent& value) const
{
...
template<>
void eng::Visitor::WriteCustom(const editor::texture::SettingsStaticComponent& value)
{
