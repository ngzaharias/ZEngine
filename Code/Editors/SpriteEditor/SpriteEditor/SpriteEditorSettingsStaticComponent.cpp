...
template<>
void eng::Visitor::ReadCustom(editor::sprite::SettingsStaticComponent& value) const
{
...
template<>
void eng::Visitor::WriteCustom(const editor::sprite::SettingsStaticComponent& value)
{
