...
void editor::entity::CommandManager::AddComponent(const str::Guid& guid, TArgs&&... args)
{
	m_ExecStack.Append(new ComponentAdd<TComponent, TArgs...>(guid, args...));
}

template<typename TComponent>
void editor::entity::CommandManager::RemoveComponent(const str::Guid& guid)
{
	m_ExecStack.Append(new ComponentRemove<TComponent>(guid, {}));
}

template <typename TComponent, typename TValue>
void editor::entity::CommandManager::UpdateComponent(
