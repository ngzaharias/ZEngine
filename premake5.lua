...
workspace "ZEngine"
	...
	{ 
		...
		"%{wks.location}/../Code/**/%{prj.name}/premake5.lua",
	...
	group "Debuggers"
		include "Code/Debuggers/DebugCrafting/premake5.lua"
	...
	group "Editors"
		...
		include "Code/Editors/SpellEditor/premake5.lua"
	...
	group "Modules"
		...
		include "Code/Modules/Crafting/premake5.lua"
		include "Code/Modules/GameState/premake5.lua"
		include "Code/Modules/Hexmap/premake5.lua"
		include "Code/Modules/Inventory/premake5.lua"
		...
		include "Code/Modules/Spellcraft/premake5.lua"
